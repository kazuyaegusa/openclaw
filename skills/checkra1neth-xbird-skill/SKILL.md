---
name: checkra1neth--xbird-skill
description: Twitter/X skill for AI agents — works with Claude Code, Cursor, Windsurf
  and 35+ agents. Powered by
homepage: https://github.com/checkra1neth/xbird-skill
metadata:
  openclaw:
    auto_generated: true
---
