...
description: "Universal LaTeX document skill for Claude Code: 27 templates, 8 scripts,
  13 reference guides. Made"
homepage: https://github.com/ndpvt-web/latex-document-skill
metadata:
  openclaw:
    auto_generated: true
---
