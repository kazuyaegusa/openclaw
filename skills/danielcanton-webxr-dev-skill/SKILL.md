---
name: danielcanton--webxr-dev-skill
description: WebXR/VR development skill for Claude Code — Three.js + Meta Quest guide
homepage: https://github.com/danielcanton/webxr-dev-skill
metadata:
  openclaw:
    auto_generated: true
---
