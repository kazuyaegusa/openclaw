---
name: silverov--yandex-direct-skill
description: 🎯 First Yandex Direct (API v5) skill for AI agents. PPC audit, campaign
  management, optimization.
argument-hint: audit | campaigns | create | keywords | report | optimize | budget
  | negative
allowed-tools:
  - Read
  - Grep
  ...
  - Bash
  - WebFetch
homepage: https://github.com/Silverov/yandex-direct-skill
metadata:
  openclaw:
    auto_generated: true
---
