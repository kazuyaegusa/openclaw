---
name: topologyhealth--claudefhirskill
description: A skill for Claude to use when creating FHIR artifacts, apps, works with
  Claude and Claude Code.
homepage: https://github.com/TopologyHealth/ClaudeFHIRSkill
metadata:
  openclaw:
    auto_generated: true
---
