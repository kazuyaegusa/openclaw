...
description: Claude Code / Cursor skill to recommend from 7000+ Nano Banana Pro image
  prompts.
platforms:
  - openclaw
  - claude-code
  ...
  - codex
  - gemini-cli
homepage: https://github.com/YouMind-OpenLab/nano-banana-pro-prompts-recommend-skill
metadata:
  openclaw:
    auto_generated: true
---
