---
name: avifenesh-agentsys
description: "AI writes code. This automates everything else · 12 plugins · 41 agents · 27 skills · for Claude"
...
metadata:
  openclaw:
    ...
    requires:
      bins:
        ["agentsys", "agnix", "agnix-cli", "cargo", "gh", "git", "node", "npm", "npx", "playwright"]
---
...
<p align="center">
  <a href="https://www.npmjs.com/package/agentsys
