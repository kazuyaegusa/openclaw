---
name: devswha--oh-my-humanizer
version: 3.2.0
description: Korean adaptation of blader/humanizer - Claude Code skill that removes
  AI writing patterns from
allowed-tools:
  - Read
  - Write
  - Edit
  ...
  - Glob
  - AskUserQuestion
homepage: https://github.com/devswha/oh-my-humanizer
metadata:
  openclaw:
    auto_generated: true
---
