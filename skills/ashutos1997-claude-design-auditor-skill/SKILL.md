---
name: ashutos1997--claude-design-auditor-skill
version: 1.2.1
description: A Claude skill that audits designs against 17 professional design rules.
homepage: https://github.com/Ashutos1997/claude-design-auditor-skill
metadata:
  openclaw:
    auto_generated: true
---
