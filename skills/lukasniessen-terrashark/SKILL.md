---
name: lukasniessen--terrashark
description: Terraform Skill for Claude Code and Codex. LLMs hallucinate a lot with
  Terraform - TerraShark fixes
homepage: https://github.com/LukasNiessen/terrashark
metadata:
  openclaw:
    auto_generated: true
---
