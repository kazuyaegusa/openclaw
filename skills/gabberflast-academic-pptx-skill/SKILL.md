...
description: A Claude Skill for creating academic presentations (conference talks,
  seminar slides, thesis
license: Proprietary. LICENSE.txt has complete terms
homepage: https://github.com/Gabberflast/academic-pptx-skill
metadata:
  openclaw:
    auto_generated: true
---
