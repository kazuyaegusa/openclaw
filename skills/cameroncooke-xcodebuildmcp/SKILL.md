...
metadata:
  openclaw:
    ...
    auto_generated: true
    requires:
      bins: ["is", "npm", "npx", "without", "xcodebuildmcp"]
---
...
[![npm version](https://badge.fury.io/js/xcodebuildmcp.svg)](https://badge.fury.io/js/xcodebuildmcp) [![License: MIT](https://img.shields.io/badge/License-MIT
