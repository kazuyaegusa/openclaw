---
name: blader--claude-code-continuous-learning-skill
description: A Claude Code skill for autonomous skill extraction and continuous learning.
  Have Claude Code get
author: Claude Code
version: 3.0.0
allowed-tools:
  - Read
  ...
  - AskUserQuestion
  - TodoWrite
homepage: https://github.com/blader/Claudeception
metadata:
  openclaw:
    auto_generated: true
---
