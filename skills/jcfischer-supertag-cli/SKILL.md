---
name: jcfischer--supertag-cli
description: CLI for Tana integration - query, create, sync, and manage Tana workspaces
  with semantic search and
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `find` | string | Yes | Tag name to search (e.g., "task", "meeting", "_" for any) |
...
| `select` | string/array | No | Field output: `"_"`for all fields,`["Email","Phone"]`for specific |
|`workspace` | string | No | Workspace alias |
