---
name: danpeg--bug-hunt
description: Adversarial bug hunting skill for Claude Code. 3 isolated agents (Hunter,
  Skeptic, Referee) find
argument-hint: "[path | -b <branch> [--base <base-branch>]]"
disable-model-invocation: true
homepage: https://github.com/danpeg/bug-hunt
metadata:
  openclaw:
    auto_generated: true
---
