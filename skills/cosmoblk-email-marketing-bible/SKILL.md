...
description: Email marketing skill for Claude Code. 55K words, 908 sources, 19 industry
  playbooks. Install the
license: MIT
metadata:
  ...
  openclaw:
    auto_generated: true
homepage: https://github.com/CosmoBlk/email-marketing-bible
---
