---
name: voidborne-d--claude-code-pro
description: ⚡ Token-efficient Claude Code workflow. Completion callbacks instead
  of polling — saves 80-97%
metadata:
  openclaw:
    emoji: ⚡
    os:
    ...
    requires:
      ...
      anyBins:
        - claude
    auto_generated: true
homepage: https://github.com/voidborne-d/claude-code-pro
---
