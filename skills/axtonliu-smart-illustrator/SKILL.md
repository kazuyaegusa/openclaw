---
name: axtonliu--smart-illustrator
description: AI-powered article illustrations with intelligent position detection
  and cover learning system.
homepage: https://github.com/axtonliu/smart-illustrator
metadata:
  openclaw:
    auto_generated: true
---
