---
name: adityasugandhi--skillsync-mcp
description: SkillSync MCP — security-gated skill management for Claude Code, OpenClaw,
  Cursor & Windsurf. 60+
homepage: https://github.com/adityasugandhi/skillsync-mcp
metadata:
  openclaw:
    auto_generated: true
---
