...
description: Claude Code skill for interacting with Elasticsearch REST API — Query
  DSL, aggregations, cluster
homepage: https://github.com/davidgeorgehope/elasticsearch-skill
metadata:
  openclaw:
    auto_generated: true
---
