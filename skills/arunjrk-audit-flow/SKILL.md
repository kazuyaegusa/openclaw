---
name: arunjrk--audit-flow
description: Claude Code skill for interactive system flow tracing across CODE, API,
  AUTH, DATA, NETWORK layers.
license: MIT
...
metadata:
  ...
  openclaw:
    auto_generated: true
homepage: https://github.com/ArunJRK/audit-flow
---
