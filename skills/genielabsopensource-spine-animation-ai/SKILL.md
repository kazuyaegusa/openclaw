---
name: genielabsopensource--spine-animation-ai
description: AI-powered Claude skill for Spine 2D skeletal animation — auto-rig, animate,
  and preview characters
homepage: https://github.com/GenielabsOpenSource/spine-animation-ai
metadata:
  openclaw:
    auto_generated: true
---
...
```json
{
  ...
  "slots": [{ "name": "back-arm", "bone": "left-arm-bone", "attachment": "back-arm" }],
  "skins": [
    {
      "name": "default",
      "attachments": {
